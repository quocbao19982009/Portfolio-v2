...
const Avatar = (props: GroupProps) => {
    ...
    const { nodes, materials } = useGLTF('model/658ea6f4d729e67ab0848b4a.glb')
    ...
    React.useEffect(() => {
        ...
        console.log('actions useEffect', actions['waving'])
...
useGLTF.preload('model/658ea6f4d729e67ab0848b4a.glb')
