                    ...
                    >
                        <div className="flex flex-col gap-3">
                            <p className="about-wrapper__info-text">
                                ...
                                everything I do. It's not just a value; it's a
                                guiding principle that shapes every aspect of my
                                work. I believe in transparent communication,
                                setting realistic expectations, and delivering
                                on promises.
                            </p>

                            <p className="about-wrapper__info-text">
                                Hello there! My name is Bao Nguyen and I am an{' '}
